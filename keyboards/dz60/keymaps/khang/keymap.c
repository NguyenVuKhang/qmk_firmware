...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_NO,    KC_NO,    KC_MSEL,  KC_NO,    KC_WSCH,  KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,  
    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_MAIL,  KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_MPLY,  
